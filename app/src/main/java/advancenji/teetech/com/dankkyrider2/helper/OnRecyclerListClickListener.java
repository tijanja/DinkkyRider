...
public class OnRecyclerListClickListener implements RecyclerView.OnItemTouchListener
{
    OnClickRecyclerList onClickStatute;
    Context context;
    RecyclerView recyclerView;
    GestureDetector gestureDetector;

    public OnRecyclerListClickListener(Context c, final RecyclerView recycler, OnClickRecyclerList onClick)
    {
        context = c;
